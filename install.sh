...
main(){
    ...
    echo -e "THANKS FOR INSTALLING ${BK}ServerSide${RT}. HAPPY HUNTING :)\nPS: If you get any bug using ServerSide, please tweet about it and tag @R0X4R, also support me on ko-fi"
    ServerSide -h 2> /dev/null
}
